...
function calculate() {
  try {
    ...
    const expression = calcValue.replace(/×/g, '*');
...
function updateCalcDisplay() {
  ...
  if (display) {
    ...
    // Auto-scroll to end if content overflows
...
function browserRefresh() {
  document.getElementById('browserFrame').src = currentBrowserUrl;
}
